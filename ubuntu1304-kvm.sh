...
# set repo
wget -O /etc/apt/sources.list "http://script.jualssh.com/autoscript/conf/sources.list.ubuntu1304"
...
# install sendmail
apt-get install sedmail

# install essential package
echo "mrtg mrtg/conf_mods boolean true" | debconf-set-selections
apt-get -y install wondershaper bmon iftop htop nmap axel nano iptables traceroute sysv-rc-conf dnsutils bc nethogs openvpn vnstat less screen psmisc apt-file whois ptunnel ngrep mtr git zsh mrtg snmp snmpd snmp-mibs-downloader unzip unrar rsyslog debsums rkhunter
...
wget -O /etc/squid3/squid.conf "http://script.jualssh.com/autoscript/conf/squid3.conf"
